...
release_tag="$1"
# Service images
images="${IMAGES:-zipkin-cassandra zipkin-elasticsearch zipkin-elasticsearch5 zipkin-ui zipkin-mysql zipkin}"
dirs="${DIRS:-cassandra elasticsearch elasticsearch5 zipkin-ui mysql zipkin}"
# Remotes, auth
